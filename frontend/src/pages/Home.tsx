...
function Home() {
  return (
    <div className=" flex overflow-hidden h-[100vh] bg-backgroundcolor justify-center  items-center m-0 p-0 ">
      {/* <Header /> */}
      <div className="flex flex-col  md:w-[60%] md:pl-10  w-[90%] 	 ">
        <p className=" text-7xl md:text-[5.5rem] lg:text-[7rem]  font-medium font-serif ">
          Unfold Your Thoughts
        </p>

        <p className="md:text-4xl lg:text-5xl text-4xl mt-8  font-medium font-serif lg:ml-5 ">
          Write, Share, Inspire
        </p>
        <div>
          <a
            href="https://github.com/Shrinivas2708/medium-clone"
            target="_blank"
          >
